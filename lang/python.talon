...
arg <user.value_syntax> (and <user.value_syntax>)*:
    user.code_parameter(value_syntax_list)
...
op <user.value_syntax> {user.infix_operators} <user.value_syntax>:
    user.insert("{value_syntax_1} {infix_operators} {value_syntax_2}")
...
# Constants
{user.constants}: insert("{constants}")
...
snip try: user.insert_snippet("try:\n\t$1\nexcept $2:\n\t$3")
