...
# Function call
call <user.function_name_syntax>: user.code_expression_function_call(function_name_syntax)
...
op <user.value_syntax> {user.infix_operators} <user.value_syntax>:
    user.code_expression_binary_infix_operator(infix_operators, value_syntax_1, value_syntax_2)
op <user.operator_syntax>: user.code_expression_binary_infix_operator("", value_syntax_1, "")
