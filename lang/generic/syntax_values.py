...
@mod.capture(rule="{user.unary_logical_operators} <user.value_syntax>")
def unary_logic_syntax(m) -> str:
    return actions.user.code_format_unary_operation(m.unary_logical_operators, m.value_syntax)

@mod.capture(rule="{user.infix_logical_operators} <user.value_syntax>")
def binary_logic_syntax_tail(m) -> str:
    return actions.user.code_format_binary_operation("", m.infix_logical_operators, m.value_syntax)

@mod.capture(rule="<user.value_syntax> (<user.binary_logic_syntax_tail>)+")
...
# @mod.capture(rule="<user.explicit_condition_syntax> | <user.value_syntax>")
# def value_syntax(m) -> str:
